...
const Right = () =>{
    return (
        ...
        <div className="rightcontainer">
            ...
            <p id="p1">Get new fashioned clothes with 50% sale 
            every weekend</p>
            <span id="span2">
            <button className="arrows-signup2" onClick={(e)=>{arrowSwitch('decrease')}} id="decrease"></button>
                
                    <label className="b-contain">
                        <input name="radio" className="none" id="1" type="radio" ref={radio1} onClick={(e)=>{ButtonsignUp(e)}} />
                        <div className="b-input" ></div>
                    </label>
                    <label className="b-contain">
                        <input name="radio" className="none" id="2" type="radio" ref={radio2} onClick={(e)=>{ButtonsignUp(e)}} />
                        <div className="b-input" ></div>
                    </label>
                    <label className="b-contain">
                        <input name="radio" className="none" id="3" type="radio" ref={radio3} onClick={(e)=>{ButtonsignUp(e)}} />
                        <div className="b-input"></div>
                    </label>

       
                   <button className="arrows-signup2 two" onClick={()=>{arrowSwitch('increase')}} id="inecrease"></button>       
            </span>
        </div>
        </>
    )
...
const Left = () =>{
    return(
        ...
        <div className="left">
            ...
            <span className="span9"><Icons.Logo/></span>
            <h6 id="signUp">Sign up</h6>
            <h6 id="sign-mini">Welcome, please enter your details</h6>
            {/*  */}
            <h6 className="headers-sign">First name</h6>
            <input type="text" name="" placeholder="Enter your firstname" id="" className="input-sign" />
            <h6 className="headers-sign">Last name</h6>
            <input type="text" placeholder="Enter your lastname" name="" id="" className="input-sign" />
            <h6 className="headers-sign">Email</h6>
            <input type="text" name="" placeholder="Enter your email" id="" className="input-sign" />
            <h6 className="headers-sign">Password</h6>
            <input type="text" name="" placeholder="Enter your password" id="" className="input-sign" />
            <button className="signup-multicolor">Sign up</button>
            <button className="signup-Google"><span id="signupgoogle-1"><div><Icons.Google/></div> Sign up with Google</span></button>
            <p id="bottom-par">Already have signed up?  <span id="bottom-span"><Link to=''>Click here </Link></span></p>
            </div>
        </div>
        </>
    )
